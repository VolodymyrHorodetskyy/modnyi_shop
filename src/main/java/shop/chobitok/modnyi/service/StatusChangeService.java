...
public class StatusChangeService {
    ...
    public List<StatusChangeRecord> getAllFromDateAndNewStatus(LocalDateTime dateCreated, Status newStatus) {
        return statusChangeRepository.findAllByCreatedDateGreaterThanEqualAndNewStatus(dateCreated, newStatus);
    }
